    ...
    return (
        <div className={classes.mobileLeft}>
            <div className={classes.top}>
                <img src="https://res.cloudinary.com/dbfv0bfmw/image/upload/v1529793665/gmas_logo.png" />
            ...
            <div className="w3-col m12 l4 window-dark w3-content">
                <div className={classes.center}>
                    ...
                    <div className={classes.textTop}>
                        <h2 className="bright-blue">As well as each stage of dApp development:</h2>
                    </div>
                    <div className={classes.linksContainer}>
                        <LinkButton
                            to="/services#dapp"
