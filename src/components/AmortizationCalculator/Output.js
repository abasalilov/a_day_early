...
class OutputComponent extends React.Component {
      ...
      datasets: [
        {
          ...
          backgroundColor: ["#42a5f5", "#dd6464"],
          hoverBackgroundColor: ["#ec6b2d", "#ec6b2d"]
        }
      ]
    };
    return data;
  ...
  calculateTotalCost() {
    ...
    return (
      amortization[amortization.length - 1].accInterestRounded + loanAmount
    );
  }
  ...
  shouldDisplayOutput() {
    ...
    return (
      Number(loanAmount) > 0 && Number(interestRate) > 0 && Number(term) > 0
    );
  }
          ...
          <Col style={{ padding: "0" }}>
            <Row className="summary-row">
              ...
              <span className="summary-value">
                {currencyFormatter.format(this.calculateTotalCost(), {
                  code: "USD"
                })}
              </span>
            </Row>
            <Row className="summary-row">
              ...
              <span className="summary-value">
                {currencyFormatter.format(this.calculateMonthlyPayment(), {
                  code: "USD"
                })}
              </span>
            </Row>
            ...
            <Row className="summary-row">
              <SummaryDonut data={this.getSummaryDonutData()} />
            </Row>
            <Row className="summary-row">
              <AmortizationTable input={this.props.input} />
            </Row>
          </Col>
        )}
        {!this.shouldDisplayOutput() && (
...
export const Output = OutputComponent;
